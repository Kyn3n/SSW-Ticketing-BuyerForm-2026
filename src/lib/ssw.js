...
/**
 * ssw theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { sswTheme } from './ssw';
 *   import './ssw.css';
 */
export const sswTheme = {
  name: 'ssw',
  __built: true,
  tokens: {
    ...
    "--color-background-surface": "light-dark(#ffffff, #172231)",
    "--color-background-body": "light-dark(#f7f4ed, #121a25)",
    "--color-background-card": "light-dark(#ffffff, #172231)",
    "--color-background-popover": "light-dark(#ffffff, #172231)",
    "--color-background-muted": "light-dark(#f1ede4, #0e1620)",
    "--color-accent": "light-dark(#815501, #F6BC6C)",
    ...
    "--color-neutral": "light-dark(#201B151A, #E9E1D933)",
    "--color-overlay": "light-dark(#201B1566, #201B1599)",
    "--color-overlay-hover": "light-dark(#201B150D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#201B151A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#121a25, #f7f4ed)",
    "--color-text-secondary": "light-dark(#5b5346, rgba(247, 244, 237, 0.65))",
    "--color-text-disabled": "light-dark(#9A8F83, #675D52)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#111111",
    "--color-on-accent": "#121a25",
    ...
    "--color-icon-primary": "light-dark(#201B15, #E9E1D9)",
    "--color-icon-secondary": "light-dark(#4E453B, #B5A99D)",
    "--color-icon-disabled": "light-dark(#9A8F83, #675D52)",
    ...
    "--color-border": "light-dark(rgba(18, 26, 37, 0.12), rgba(255, 255, 255, 0.12))",
    "--color-border-emphasized": "light-dark(rgba(18, 26, 37, 0.24), rgba(255, 255, 255, 0.24))",
    "--color-skeleton": "light-dark(#B5A99D, #4E453B)",
    ...
    "--color-background-inverted": "light-dark(#201B15, #FFFBF5)",
    "--color-track": "light-dark(#B5A99D, #4E453B)"
  },
  localTokens: {
  ...
  __localTokenLineage: ["neutral","ssw"],
  components: {
    "heading": {
      "level:1": {
    ...
    "button": {
      ...
      "variant:primary": {
        "backgroundColor": "#c59042",
        "color": "#121a25",
        ":hover": {
          "backgroundColor": "#d7a95f"
        }
      }
    },
    "badge": {
